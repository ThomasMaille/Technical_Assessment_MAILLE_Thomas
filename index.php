...
<div class="container py-4">
    ...
    <!-- Barre de sélection du client -->
    <div class="d-flex justify-content-end mb-4">
        <form id="clientForm" class="d-flex align-items-center">
            <select class="form-select form-select-sm client-select" name="client" id="client">
    ...
    <div class="text-center mb-5">
        <h1 class="display-5 fw-bold text-primary header-title">Tool4cars</h1>
        <p class="text-muted fs-6">Le logiciel de gestion de voiture pensé POUR les utilisateurs</p>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="dynamic-div card-body text-center" data-module="cars" data-script="ajax" id="resultat">
            <?php if(!isset($_COOKIE['client']) || $_COOKIE['client'] === null) { ?>
                ...
                <p class="card-text">Veuillez choisir un client dans la liste en haut à droite pour afficher les informations.</p>
            <?php } ?>
        </div>
    </div>
